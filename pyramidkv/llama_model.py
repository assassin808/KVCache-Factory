    ...
    **kwargs,
    ...
    if past_key_value is not None:
        ...
        if key_states.shape[-2] == kv_seq_len:
            ...
            hidden_states, key_states_compress, value_states_compress = self.kv_cluster.update_kv_h2o(hidden_states, key_states, query_states, value_states, attention_mask, self.num_key_value_groups)

            _, _, hidden_states = past_key_value.update(key_states_compress, value_states_compress, self.layer_idx, cache_kwargs, hidden_states)
            ...
            retained_key_states, retained_value_states, unit_key_states, unit_value_states, key_magnitude, value_magnitude, mask_k, mask_v, previous_retained_key_states, previous_retained_value_states = self.kv_cluster.update_kv(key_states_compress, query_states, value_states_compress, attention_mask, self.num_key_value_groups, self.layer_idx, previous_key_states, previous_value_states, hidden_states, previous_hidden_states)
